...
public class Integers {
    ...
    private static final double LOG_BASE_TWO = Math.log10(2);
    ...
    public static final String toBinaryUsingDivideAndModulus(int numberToConvert) {
        ...
        while (integer > 0) {
            temp = integer;
            integer = temp / BASE_TWO;
            builder.append(temp % BASE_TWO);
        }
    ...
    public static final boolean powerOfTwoUsingRecursion(int numberToCheck) {
        ...
        if (number == 0 || number % BASE_TWO != 0) return false;
        return powerOfTwoUsingRecursion(number / BASE_TWO);
    }

    public static final boolean powerOfTwoUsingLog(int numberToCheck) {
        int number = numberToCheck;
        double doubleLog = Math.log10(number) / LOG_BASE_TWO;
    ...
    private static String handleUnderOneThousand(int number) {
        StringBuilder builder = new StringBuilder();
        int x = number;
        int m = x / HUNDRED;
        int r = x % HUNDRED;
    ...
    public static String toEnglish(int number) {
        ...
        StringBuilder builder = new StringBuilder();
        if (x == 0) return singleDigits.get(x);
